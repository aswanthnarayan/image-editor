  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 w-full items-center">
        <button
          className="bg-primary hover:bg-primary/90 text-white rounded-xl shadow-lg flex items-center justify-center w-10 h-10 mb-2 transition-all duration-150 border-2 border-primary outline-none focus:ring-2 focus:ring-primary/40"
          title="Add New"
        >
        ...
        <div className="flex flex-col gap-2 w-full items-center">
          {SidebarItems.map((item) => (
            <button
              key={item.label}
              className={`flex flex-col items-center justify-center py-3 rounded-lg transition-all w-full
      ...
      {/* Optionally, add user profile or settings at the bottom */}
